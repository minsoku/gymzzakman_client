...
export const Button = () => {
    ...
    return (
        <div
            ...
            <div
                className="shadow-[2px_2px_3px_rgba(0,_0,_0,_0.05)] rounded-3xs flex flex-col items-end justify-start pt-[0.875rem] px-[1.5rem] pb-[0.812rem] gap-[0.587rem] cursor-pointer border-[1px] border-solid border-darkgray"
            ...
            <button
                className="cursor-pointer pt-[0.875rem] pb-[0.812rem] pr-[2rem] pl-[2.012rem] bg-[transparent] shadow-[2px_2px_3px_rgba(0,_0,_0,_0.05)] rounded-3xs flex flex-col items-end justify-start gap-[0.525rem] border-[1px] border-solid border-darkgray"
            ...
            <button
                className="cursor-pointer pt-[0.875rem] pb-[0.812rem] pr-[2.625rem] pl-[2.743rem] bg-cornflowerblue shadow-[2px_2px_3px_rgba(0,_0,_0,_0.05)] rounded-3xs flex flex-col items-end justify-start gap-[0.587rem] border-[1px] border-solid border-cornflowerblue">
                <div
                    className="w-[9.875rem] h-[4.944rem] relative shadow-[2px_2px_3px_rgba(0,_0,_0,_0.05)] rounded-3xs bg-cornflowerblue box-border hidden border-[1px] border-solid border-cornflowerblue"/>
                <div className="flex flex-row items-start justify-end py-[0rem] pr-[1.343rem] pl-[1.375rem]">
                    <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_33_12)">
                            <path d="M5.8567 13.1628V7.64128H3.71235C3.14363 7.64128 2.5982 7.85942 2.19606 8.24773C1.79392 8.63603 1.56799 9.16269 1.56799 9.71183V22.1352C1.56906 22.2633 1.60707 22.3887 1.67777 22.4972C1.74847 22.6057 1.84906 22.693 1.96827 22.7494C2.08312 22.7999 2.20975 22.82 2.3353 22.8079C2.46084 22.7958 2.58082 22.7518 2.68306 22.6804L6.3642 20.0646H15.9709C16.2418 20.0723 16.5115 20.0263 16.7632 19.9293C17.0149 19.8323 17.2434 19.6865 17.4343 19.5008C17.6253 19.3151 17.7748 19.0935 17.8734 18.8497C17.9721 18.606 18.0179 18.3453 18.008 18.0838V17.3039H10.1454C9.00797 17.3039 7.91712 16.8676 7.11283 16.091C6.30855 15.3144 5.8567 14.2611 5.8567 13.1628Z" fill="white"/>
                            <path d="M22.2968 2.80998H10.1455C9.57673 2.80998 9.03131 3.02813 8.62917 3.41643C8.22702 3.80474 8.0011 4.33139 8.0011 4.88054V13.1628C8.0011 13.7119 8.22702 14.2386 8.62917 14.6269C9.03131 15.0152 9.57673 15.2333 10.1455 15.2333H19.8308L23.2475 17.7939C23.349 17.8664 23.4687 17.9116 23.5942 17.925C23.7198 17.9383 23.8468 17.9193 23.9622 17.8698C24.0839 17.8139 24.1867 17.7259 24.2587 17.616C24.3308 17.5061 24.3693 17.3787 24.3697 17.2487V4.88054C24.37 4.34314 24.1539 3.82668 23.7671 3.4403C23.3803 3.05392 22.853 2.82789 22.2968 2.80998Z" fill="white"/>
                        </g>
                        <defs>
                            <clipPath id="clip0_33_12">
                                <rect width="25.7322" height="24.8467" fill="white" transform="translate(0.138428 0.0492392)"/>
                            </clipPath>
                        </defs>
                    </svg>
                ...
                <div
                    className="w-[4.356rem] h-[0.906rem] relative text-[0.938rem] tracking-[-0.05em] leading-[1.125rem] font-medium font-inter text-white text-center inline-block shrink-0 z-[1]">
                    커뮤니티
                </div>
            </button>
        </div>
