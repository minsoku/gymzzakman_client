...
export default function Home() {
  const onText1Click = useCallback(() => {
    // Please sync "로그인" to the project
  }, []);

  const onText3Click = useCallback(() => {
    // Please sync "회원가입" to the project
  }, []);

  return (
      <div className="w-full h-[64rem] relative bg-whitesmoke overflow-hidden flex flex-row items-start justify-start gap-[0.625rem] leading-[normal] tracking-[normal] text-center text-[1.25rem] text-white font-inter mq675:h-auto">
        ...
        <main
          ...
          {/*<img*/}
          {/*    // className="absolute top-[-7.906rem] left-[-12.237rem] w-[141.131rem] h-[82.581rem] object-cover"*/}
          {/*    className=""*/}
          {/*    alt=""*/}
          ...
          <div className="absolute top-[42.969rem] left-[59.5rem] tracking-[-0.07em] z-[2]">
            ㅣ
          </div>
          <div
