...
export default function Page() {
  return (
      <div className="h-screen w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[3.312rem] box-border gap-[9.375rem] leading-[normal] tracking-[normal] text-center text-[1.25rem] text-cornflowerblue-100 font-inter mq450:gap-[2.313rem] mq725:gap-[4.688rem]">
